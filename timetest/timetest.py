...
class Event(object):
    ...
    """
    def __init__(self, funcobj, title, *args, **kwargs):
        self.fn = funcobj
        self.title = title
...
class TimeTest(object):
    ...
    def _platform_info(self):
        ''' Get information about system where system is running
        '''
    ...
    def addTest(self, title, funcobj, *args, **kwargs):
        ''' Add new test
        '''
        self._construct_event(funcobj,title, *args,**kwargs)

    def _analysis(self, event, delta):
        ''' Checking if flags 'hardlimit` or 'expected' is on
        '''
    ...
    def run(self):
        ''' Main loop for running timetests
        '''
        report = []
